    ...
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player.bind('onTrackDataLoaded.scPlayer', function(event) {
          ...
          $.each(tracks, function(index, track) {
            ...
            $('<li data-song-id="' + track.id +'" class="playlist-item"><a href="' + track.permalink_url +'">' + track.title + '</a><span class="sc-track-duration">' + timecode(track.duration) + '</span></li>').data('sc-track', {id:index}).toggleClass('active', active).appendTo($list);
